...
def find_element(driver, selectors):
    ...
    for selector in selectors[1:]:
        ...
        element = element.driver.find_element(By.CSS_SELECTOR,selector)
    return element
...
def get_detection_details(driver):
    def get_single_detection(element):
        name = element.driver.find_element(By.CSS_SELECTOR,'.engine-name').text
        details = element.driver.find_element(By.CSS_SELECTOR,'.individual-detection').text
